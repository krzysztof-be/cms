  ...
  <div id="wrapper">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                <a href="#" class="dropdown-toggle btn" data-toggle="dropdown">
                  <i class="glyphicon glyphicon-bell"></i> Powiadomienia 
                ...
                @foreach($notifications as $n)
                  <li><a href="{{ url($n->url) }}">
                    <i class="glyphicon glyphicon-{{ $n->icon}}"></i>
                    {!! $n->message !!}
                  </a></li>
                @endforeach
   ...
   <script>
    ...
    tinymce.init({
        ...
        toolbar1: "bold italic underline strikethrough | styleselect |  alignleft aligncenter alignright alignjustify bullist numlist | outdent indent blockquote | undo redo | link unlink anchor image media code | table | subscript superscript | fullscreen",
